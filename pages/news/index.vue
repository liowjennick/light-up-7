    ...
    <div id="news">
        ...
        <div class="section-container" style="text-align: center; flex-direction: column;">
            <div>
                ...
                <p class="font-white font-weight-100">Learn more about our shining work for clients, plus illuminating
                    insights and company stories.</p>
            </div>
            <!-- Animation Here -->
            <div>
                <DotLottieVue class="lottie-globe-rotate" autoplay loop
                    src="https://lottie.host/bd409324-1f4c-4d8c-a731-23a796b11e9b/sQASIUyTcN.json" />
            ...
            <div v-for="thumb in news" :key="thumb.id" style="width: 100%;" class="divider-parent"
                ...
                <div class="section-container full-screen-start-start divider-child news-row"
                    ...
                    <div class="news-content-container full-screen-start-center"
                        ...
                        <p class="font-weight-200" style="font-size: 18px;"><span class="mr-4">{{ thumb.created_at
                                }}</span> | <span class="ml-4">{{ thumb.category }}</span></p>
